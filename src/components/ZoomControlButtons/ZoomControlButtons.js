...
export default class ZoomControlButtons extends Component {
    ...
    render() {
        ...
        return (
            <div id="zoom-controls" data-testid = "zoom-btns">
                <div data-testid = "zoomInButton" id="in" className="c-button" onClick={onZoomIn}>
                ...
                <div data-testid = "zoomOutButton" id="out" className="c-button" onClick={onZoomOut}>
                    <div className="c-ripple js-ripple">
                        <span className="c-ripple__circle"></span>
